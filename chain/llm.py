...
from config import OPENAI_API_KEY, ANTHROPIC_API_KEY, OPENAI_MODEL_ID, OPENAI_MODEL_ID_MINI, ANTHROPIC_MODEL_ID
...
def get_llm(provider: str = "openai"):
    ...
    raise ValueError(f"Unknown LLM provider: {provider!r}. Expected 'openai', 'openai-mini', or 'anthropic'.")
